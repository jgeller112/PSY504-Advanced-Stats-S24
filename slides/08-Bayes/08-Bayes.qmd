...
#| echo: false
#| 
x=distribution_normal(30, 0, 100)
plot(density(x))
```
...
::: callout-note
pd is pretty cool! It tells us how much of the distribution is completely positive or negative. It is correlated with p values!
:::
...
-   It doest in our case so not significant!

## Significant differences

-   Use `marginaleffects` to get mean differences between variables
...
-   Do my students’ course grades depend on whether they attend lectures synchronously or asynchronously and average viewing time?
...
6.  Include BFs for model comparisons or parameters
